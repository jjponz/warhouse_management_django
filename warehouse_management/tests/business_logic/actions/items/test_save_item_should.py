...
class TestSaveItemShould(TestCase):
    ...
    def test_return_action_result_with_errors_if_item_has_not_name(self):
        ...
        self.assertEqual("El nombre del item es requerido",
    ...
    def test_update_model_if_exists_and_is_valid(self):
        ...
        self.assertEqual("Upgrade notes",
                         item_memory_repository.get(
                             item_memory_repository.last_id_generated()).notes)
